---
title: "Exploriong budget allocation for the Ministry of Environment, Forests and Climate Change (2020/2021)"
author: "CivicDataLab"
output: 
  html_document:
    df_print: default
...
<br />Last updated: `r format(Sys.time(), '%d %B, %Y')` (See [changelog]()).
...
- Look at the Top and Bottom **20** departments in terms of increase in the budget allocation in this specific period


```{r Analysis - Compare the actuals from 2018-19, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
